...
#plot
plot_heatmap(Ps_sample_id, method = "NMDS", distance = "bray")
...
# Install Miscellaneous functions for metagenomic analysis 
...
out <- iNEXT(count_tab, q=0, datatype = "abundance")
out$DataInfo
...
ggiNEXT(out_4864, type = 1, facet.var = "order", color.var = "site")
...
ggiNEXT(out_by_site, type=1, facet.var = "order", color.var = "site")
ggiNEXT(out_by_site, type=2, facet.var = "order", color.var = "site")
ggiNEXT(out_by_site, type=3, facet.var = "order", color.var = "site")
```
